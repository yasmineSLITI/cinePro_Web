 ...
 */
final class Version20220306151957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP attestation, DROP temoignage, DROP experiance');
    }
