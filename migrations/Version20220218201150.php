 ...
 */
final class Version20220218201150 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE atestation attestation VARCHAR(255) DEFAULT NULL');
    }
