 ...
 */
final class Version20220221234642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE taille taille INT DEFAULT NULL');
    }
