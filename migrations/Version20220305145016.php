 ...
 */
final class Version20220305145016 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD activation_token VARCHAR(255) DEFAULT NULL, DROP is_verified');
    }
