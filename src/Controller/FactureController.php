...
class FactureController extends AbstractController
{
    ...
    public function imprimer()
    {
        ...
        return $this->render('facture/impression.html.twig', [
            "ff" => $listec
        ]);
    }
    /**
    ...
    public function viderFacture()
    {
        ...
        $listesup = $this->getDoctrine()->getRepository(Facture::class)
            ->viderFacture();
    ...
    /**
     * @Route("/removeFacture", name="removeFacture")
     */
    public function removeFacture(NormalizerInterface $Normalizer)
    {
        ...
        return new Response("facture supprimé avec succés" . json_encode($jsonContent));
    }
}
