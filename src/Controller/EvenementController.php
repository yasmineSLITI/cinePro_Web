...
return $this->redirectToRoute('listerEv'); 
    ...
    public function affiche_pour_réalisateur(EvenementRepository $rep , $id ,request $request) : Response{
        ...
        ['eve'=>$event]);}
    /**
     * @Route("/mesdemandesrea", name="reaAffiche")
     */
    public function affiche_pour_réalisateur_stat(EvenementRepository $rep ,Request $request) : Response{
   ...
   public function ajouter_event_par_realisateur_par_id(Request $req, $id ,Request $reqq) : Response{
    ...
    /**
     * @Route("/ajouterEvenement",name="ajouterE_id")
     */
   public function ajouter_event_par_realisateur_par_stat(Request $req,Request $reqq) : Response{
    $ev= new Evenement();
    $rea=new Realisateur();
    $rea =  $this->getDoctrine()->getRepository(Realisateur:: class)->findOneBy(['numrea'=>1]);
